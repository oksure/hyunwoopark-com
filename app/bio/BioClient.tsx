...
import { FaArrowLeft, FaCopy, FaFilePdf } from "react-icons/fa6";
...
export default function BioPage() {
  ...
  const bios = [
    ...
    },
    {
      ...
      lang: "ko",
      length: "표준 약력",
      text: `박현우는 서울대학교 데이터사이언스대학원 교수다. AI와 데이터가 인간의 판단, 조직의 일, 제품과 서비스의 설계를 어떻게 바꾸는지 연구하며, 데이터 시각화와 공급망 네트워크도 다룬다. 서울대학교 데이터사이언스대학원 교무부원장을 지냈고, 서울대 부임 전에는 오하이오주립대학교 피셔경영대학 조교수와 조지아공과대학 박사후연구원으로 근무했다. 연구 성과는 Academy of Management Review, Journal of Operations Management, Production and Operations Management, Research Policy, IEEE Transactions on Visualization and Computer Graphics 등에 게재됐다. 2024년도 한국차세대과학기술한림원(Y-KAST) 정책학부 회원으로 선출됐으며, 같은 해 INFORMS TIMES 회장을 맡았고 2025년 INFORMS TIMES Distinguished Service Award를 수상했다. 외교부 외교 AI 외부 전문가 자문단 위원, SK하이닉스 VPP 자문교수 등 산학 자문 활동도 하고 있다. 서울대학교 전기공학사, UC버클리 정보관리시스템 석사, 조지아공과대학 산업공학 박사 학위를 받았다.`,
    },
  ];
