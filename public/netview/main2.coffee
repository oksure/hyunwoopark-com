  ...
  d3.json url
    .then (data) ->
      ...
      node = node.data graph.nodes, (d) -> d.id
        ...
        .style 'stroke-width', (d) -> nodeStrokeWidth d
        .call drag
        .on 'mouseover', (d) ->
...
nodeFillColor = (d) ->
  if d.group==0 then return '#FFFFFF'
  if d.group==1 then return '#FFFFFF'
  if d.group==2 then return '#7F7F7F'
  if d.group==3 then return '#000000'

nodeStrokeWidth = (d) ->
  if d.group==0 then return 5
  if d.group==1 then return 1
  return 0
